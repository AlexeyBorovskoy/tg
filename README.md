...
- Загружает всю историю сообщений
- Обрабатывает OCR для всех медиафайлов
- Создаёт сводный инженерный документ
- Добавляет в конфигурацию
- Индексирует в RAG

**После добавления:** сервис автоматически обнаружит новый канал при следующем цикле (без перезапуска).

📖 [Подробное руководство](docs/add_channel_guide.md)
...
- [Добавление новых чатов](docs/add_channel_guide.md)
